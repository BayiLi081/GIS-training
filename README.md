...
* support open science
  - Examples use open-source tools and public datasets where possible. 
  - Suggestions and pull requests are welcome.
* place geospatial data at the centre of analysis and show how to source and process it
